...
public class Two1stTemplate extends Template {

	/**
	 * Create the panel.
	 */
	private JPanel panel;
	private static Two1stTemplate instance = new Two1stTemplate();
	private JLabel label;
	private JLabel label_2;
	
	private Two1stTemplate() {		
		panel=new JPanel();
		panel.setBackground(Color.ORANGE);
		panel.setLayout(new MigLayout("insets 0 0 0 0", "[grow]", "[50%]2[50%]"));
	...
	public static Two1stTemplate getInstance(){
	      return instance;
	   }
				    	 ...
				    	 int nameEdit=1;   	    
				     	 ...
				     	 for(File filesArr:files){
				    	            ...
				    	            ima2 = new BufferedImage(width2,height2, BufferedImage.TYPE_INT_ARGB);
				  		    		...
				  		    		if(width1>width2)
				  		    			outputbuffer = new BufferedImage(width1,height1+height2,image.getType());
				  		    		else
				  		    			outputbuffer = new BufferedImage(width2,height1+height2,image.getType());		  		    		
				  		    		...
				  		    		g_out.drawImage(ima2,0,image.getHeight()+1 , null);
				  		    		g_out.dispose();	
